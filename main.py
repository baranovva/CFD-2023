...
for it in range(n_iter):
    grad_p = calc_gradient(ni=ni, nj=nj, p=p,
    ...
    figure(5, 'p', grad_p[1:ni, 1:nj], 'turbo')
...
print('Maximum DivVx-error:', np.max(div_v_error[1:ni, 1:nj, 0]))
print('Maximum DivVy-error:', np.max(div_v_error[1:ni, 1:nj, 1]))
'''
