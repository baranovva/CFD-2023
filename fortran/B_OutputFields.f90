Subroutine B_OutputFields(IO,NI,NJ,X,Y,P,GradP,GradPError,V,DivV,DivVError,LapP,LapPError)
  Real,Dimension(NI,NJ):: X,Y
  Real,Dimension(0:NI,0:NJ)::P, DivV, DivVError, LapP, LapPError
  Real,Dimension(0:NI,0:NJ,2)::GradP, GradPError, V

  Write(IO,*) 'VARIABLES = "X", "Y", "P", "GradP_X", "GradP_Y", "GradPError_X", "GradPError_Y", "V_x", "V_y", "DivV", "DivVError", "LapP", "LapPError"' 
